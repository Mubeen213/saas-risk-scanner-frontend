...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles: Record<ButtonVariant, string> = {
    primary:
      "bg-gray-900 text-white hover:bg-gray-800 focus:ring-blue-500 border border-gray-900",
    secondary:
      "bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-blue-500 border border-gray-300",
    ghost:
      "bg-transparent text-gray-700 hover:bg-gray-50 focus:ring-blue-500 border border-transparent",
    danger:
